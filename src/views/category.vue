        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 me-4 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="#">Is It Woke?</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Buy Woke-Free</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" tabindex="-1" aria-disabled="true">About Us</a>
                    </li>
                </ul>
                <button class="btn btn-light rounded-pill ps-4 pe-4" href="#">Sign Up</button>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Pillar Page</li>
            </ol>
        </nav>
